...
public class SecurityConfig implements WebMvcConfigurer{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests()
                ...
                .antMatchers(HttpMethod.GET, "/bar/**", "/api/order/byuuid","/api/order/contents","/api/order","/api/order/toprocess","/api/user/classroom","/api/user/all","/api/user/byemail","/api/user/byusername","/api/user/byuuid").hasAnyRole("ADMIN","BAR")
                ...
                .antMatchers(HttpMethod.GET, "/admin/**","/api/user/cart","/api/user").hasRole("ADMIN")
